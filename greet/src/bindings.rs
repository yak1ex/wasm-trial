    ...
    pub mod yakex {
        pub mod greet {
            ...
            pub mod greetable {
                ...
                #[doc(hidden)]
                macro_rules! __export_yakex_greet_greetable_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "yakex:greet/greetable#name")] unsafe extern "C" fn export_name()
                        -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_name_cabi::<$ty > () } } #[unsafe (export_name =
                        "cabi_post_yakex:greet/greetable#name")] unsafe extern "C" fn
                        _post_return_name(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_name::<$ty > (arg0) } }
                        #[unsafe (export_name = "yakex:greet/greetable#greet")] unsafe
                        extern "C" fn export_greet(arg0 : * mut u8, arg1 : usize,) -> *
                        mut u8 { unsafe { $($path_to_types)*:: _export_greet_cabi::<$ty >
                        (arg0, arg1) } } #[unsafe (export_name =
                        "cabi_post_yakex:greet/greetable#greet")] unsafe extern "C" fn
                        _post_return_greet(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_greet::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_yakex_greet_greetable_cabi;
...
macro_rules! __export_greetable_provider_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::yakex::greet::greetable::__export_yakex_greet_greetable_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::yakex::greet::greetable);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:yakex:greet:greetable-provider:encoded world"
)]
#[doc(hidden)]
...
\0\x15yakex:greet/greetable\x05\0\x04\0\x1eyakex:greet/greetable-provider\x04\0\x0b\
\x18\x01\0\x12greetable-provider\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
